...
function hashFunction(form)
{
	...
	var msg=pass.concat(salt);
	form.hashedvalue.value=CryptoJS.SHA256(msg);
	//alert(form.hashedvalue.value);
}
</script>
</head>
...
<form id="password_form" method ="Post" action = "/OutsourcedEmail/AuthenticatorPath">
<h4>Hello <%=session.getAttribute("name")%></h4>  
Password <input name ="password" type="password">
<input type="hidden" name="Salt" value=<%=salt%>> 
<input type="hidden" name="hashedvalue" value="rad">
<input name="Submit" type="submit" value="Submit" onclick="hashFunction(this.form)"/>
</form>
